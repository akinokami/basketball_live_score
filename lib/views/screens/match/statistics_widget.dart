  ...
  Widget build(BuildContext context) {
    ...
    return Obx(()=>
       SingleChildScrollView(
        child:((matchController.matchDetails.value.homeTeam?.statisticsForEventList==null)&&(matchController.matchDetails.value.homeTeam?.statisticsForEventList?.teamStatistics?["${events?.id}"]?[0].statList?.length??0)<2)?
